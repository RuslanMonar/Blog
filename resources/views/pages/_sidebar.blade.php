<div class="col-md-4" data-sticky_column>
    <div class="primary-sidebar">
        ...
        <aside class="widget news-letter">
            <h3 class="widget-title text-uppercase text-center">Підпишіться щоб отримувати нові пости</h3>
            ...
            <div id="widget-feature" class="owl-carousel">
                ...
                <div class="item">
                    <div class="feature-content">
                        ...
                        <a href="{{route('post.show' , $post->slug)}}" class="overlay-text text-center featured-post">
        ...
        <aside class="widget pos-padding">
            <h3 class="widget-title text-uppercase text-center">Нещодавні пости</h3>
        ...
        <aside class="widget border pos-padding">
            ...
            <ul>
                <li>
                    <a href="#"> <h6>Назва</h6></a>
                    <span class="post-count pull-right">Кількість постів</span>
                </li>
