        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="top-comment"><!--top comment-->
                    ...
                    @endif
                    <p>Меня зовут Анастасия и я занимаюсь модельной репортажной фотографией</p>
                </div><!--top comment end-->
                <div class="row"><!--blog next previous-->
                    <div class="col-md-6">
                        @if ($post->hasPrevious())   
                        <div class="single-blog-box">
                            <a href="{{route('post.show' , $post->getPervious()->slug)}}">
                                <img src="{{$post->getPervious()->getImage()}}" alt="">

                                <div class="overlay">

                                    <div class="promo-text">
                                        <p><i class=" pull-left fa fa-angle-left"></i></p>
                                        <h5>{{$post->getPervious()->title}}</h5>
                                    </div>
                                </div>
                ...
                <div class="related-post-carousel"><!--related post carousel-->
                    <div class="related-heading">
                        <h4>Вам також має сподобатись:</h4>
                    </div>
                    <div class="items">
                ...
                <div class="bottom-comment"><!--bottom comment-->
                    <a  class=" btn pull-right" onclick="$('#{{$comment->id}}' ).toggle( 'fast');">Відповісти</a>
                    ...
                    {!! Form::open(['route' => 'comment.reply' ,'method' => 'post' , 'class' => 'replay-comment' , 'id' => $comment->id]) !!}
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-md-8">
										<textarea class="form-control" rows="6" name="message"
                                                  ...
                                                  <button class="btn send-btn ">Надіслати</button>
                            </div>
                        </div>
                    {!! Form::close() !!}
                </div>
                ...
                <div class="leave-comment"><!--leave comment-->
                    <h4>Залиште коментарій до поста</h4>
                    ...
                    <input type="hidden" name="post_id" value="{{$post->id}}">
                        ...
                        <button class="btn send-btn">Надіслати коментарій</button>
                    </form>
                </div><!--end leave comment-->
                @else
                <h3>Ввійдіь в аккаунт щоб залишати коментарі</h3>
                @endif
            </div>
