        ...
        <div class="container">
            <div class="menu-content">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand logo-fix" href="/"><img src="/images/logo-2.png" alt=""></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav text-uppercase">
                        ...
                        <li><a href="about-me.html">{{__('Про меня')}}</a></li>
                        <li><a href="contact.html">{{__('Контакты')}}</a></li>
                    </ul>
                    <ul class="nav navbar-nav text-uppercase pull-right">
                        @if(Auth::check())
                            <li><a href="/profile">{{__('Мой профиль')}} <img
                                        style="width:20px; height:20px;border-radius: 50%;  object-fit:cover;"
                                        src="{{ Auth::user()->getImage() }}" alt=""></a></li>
                            <li><a href="/user_posts/create ">{{__('Написать пост')}}</a></li>
                            <li><a href="/logout">{{__('Выйти')}}</a></li>
                        @else
                            <li><a href="/register">{{__('Регистрация')}}</a></li>
                            <li><a href="/login">{{__('Ввойти')}}</a></li>
                        @endif
                    </ul>
